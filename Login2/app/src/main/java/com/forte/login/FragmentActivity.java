...
public class FragmentActivity extends SherlockFragmentActivity {
	...
	public static class CarBrandsFragment extends SherlockListFragment {
		boolean dualPane;
		...
		public void onActivityCreated(Bundle savedInstanceState) {
			...
			String[] cardBrandNames = new String[CarBrandsCollection.CAR_BRANDS.length];
			for (int i = 0; i < cardBrandNames.length; i++) {
				cardBrandNames[i] = CarBrandsCollection.CAR_BRANDS[i].name;
			}

			// Populate list with our static array of titles.
			setListAdapter(new ArrayAdapter<String>(getActivity(), R.layout.car_brands_layout, android.R.id.text1,
					cardBrandNames));
	...
	public static class DetailsFragment extends SherlockFragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			text.setText(CarBrandsCollection.DESCRIPTION[getShownIndex()]);
			return scroller;
		}
	}
